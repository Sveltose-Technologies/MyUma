...
import { getCategoriesAPI, createListingAPI } from "../features/auth/api";
...
const Listing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic Validation
    if (!formData.category || !formData.title || images.length === 0) {
      return toast.warn(
        "Please fill required fields and upload at least one image.",
      );
    }
    ...
    try {
      ...
      // 3. Append Items (Strings must be stringified for FormData)
          ...
          <div className="col-lg-10">
            ...
            >
              ...
              <form className="p-4 p-md-5" onSubmit={handleSubmit}>
                ...
                {/* Social links (Truncated for brevity, add twitter/instagram here) */}
                <div className="mb-5">
                  <h5
                    className="text-uppercase fw-bold mb-4"
                    style={{ color: theme.primary, letterSpacing: "1px" }}
