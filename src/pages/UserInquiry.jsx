...
const UserInquiry = () => {
  ...
  const userEmail = currentUser?.email; // फ़िल्टर करने के लिए ईमेल का उपयोग
  ...
  const fetchMyInquiries = async () => {
    try {
      ...
      if (res?.data) {
        // केवल वही inquiry दिखाएं जो लॉगिन यूजर के ईमेल से मेल खाती हों
