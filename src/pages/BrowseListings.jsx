    ...
    <div className="min-vh-100 bg-light py-5">
      <div className="container">
        ...
        <div className="card border-0 shadow-sm p-4 mb-5 rounded-4">
          <div className="row g-3 align-items-end">
            <div className="col-12 col-md-5">
              <label className="form-label small fw-800 text-navy text-uppercase ls-1">Search</label>
              <div className="input-group bg-light rounded shadow-none border">
                <span className="input-group-text bg-transparent border-0">
                  <Search size={18} />
                </span>
            ...
            <div className="col-6 col-md-3">
              <label className="form-label small fw-800 text-navy text-uppercase ls-1">Category</label>
              <select
                className="form-select border shadow-none"
                value={filter.category}
            ...
            <div className="col-3 col-md-2">
              <label className="form-label small fw-800 text-navy text-uppercase ls-1">Min $</label>
              <input
                type="text"
                className="form-control border shadow-none"
                placeholder="Min"
            ...
            <div className="col-3 col-md-2">
              <label className="form-label small fw-800 text-navy text-uppercase ls-1">Max $</label>
              <input
                type="text"
                className="form-control border shadow-none"
                placeholder="Max"
            ...
            <div className="col-12 text-end pt-2">
              <button className="uma-btn-navy uma-btn px-5 w-20 w-md-auto" onClick={handleApplyFilters}>
                APPLY FILTERS
              </button>
            </div>
          </div>
        ...
        <div className="row g-4">
          {filteredListings.map((item) => (
            <div key={item._id} className="col-12 col-md-6 col-lg-4">
              ...
              >
  {/* Image Container */}
<div className="ratio ratio-4x3 position-relative" style={{ overflow: 'hidden' }}>
  {/* IMAGE */}
  <img
    src={getImgURL(item.images?.[0])}
    alt={item.title}
