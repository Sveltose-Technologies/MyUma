...
//       price: "19.99",
//       features: ["One listing per location", "No Expiration", "24/7 Support"],
//     },
//     {
//       name: "MARKETPLACE",
//       price: "0.00",
//       features: [
//         "This plan includes free listing to celebrate our launch. Offer expires in 60 days.",
//         "60 days",
//         "24/7 Support",
//       ],
//     },
...
//       {/* Header Section */}
//       <div className="bg-light py-5 text-center mb-1">
//         <h1 className="display-5 fw-bold text-navy">Pricing</h1>
//         <p className="text-muted small">
//           MyUma Business Listing and Directory
//         </p>
//       </div>
...
//               {/* Small Simple Card */}
//               <div className="card h-100 border-1 shadow-sm rounded-4 p-4 text-center">
//                 <h5 className="fw-bold text-navy mb-1 text-uppercase ls-1">
//                   {plan.name}
//                 </h5>
//                 <div className="text-muted small mb-4">{plan.price}</div>

//                 <hr className="opacity-10 mb-4" />

//                 <div className="text-start px-2">
//                   <p className="fw-bold small text-navy mb-3">Pro Features</p>
//                   <ul className="list-unstyled mb-5">
//                     {plan.features.map((feature, i) => (
//                       <li
//                         key={i}
//                         className="small d-flex align-items-start  text-muted">
//                         <i className="bi bi-check2 text-gold fw-bold me-2 mt-1"></i>
//                         <span>{feature}</span>
//                       </li>
//                     ))}
//                   </ul>
...
//                 {/* Button using your index.css class */}
//                 <div className="mt-auto">
//                   <button className="btn bg-navy text-white w-100 py-2 rounded-3 fw-bold">
//                     Add Plan
//                   </button>
//                 </div>
//               </div>
