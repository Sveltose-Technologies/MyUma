...
//                       <li className="mb-3 d-flex align-items-start small text-navy fw-bold">
//                         <i
//                           className="bi bi- megaphone-fill me-2"
//                           style={{ color: accent }}></i>
//                         {plan.listings > 0
//                           ? `Can Post ${plan.listings} Listings`
//                           : "Unlimited Listings"}
//                       </li>

//                       <li
//                         className={`mb-3 d-flex align-items-start small ${plan.chatIsActive ? "text-navy fw-bold" : "text-muted opacity-50"}`}>
//                         <i
//                           className={`bi ${plan.chatIsActive ? "bi-chat-dots-fill" : "bi-chat-left-x"} me-2`}
//                           style={{
//                             color: plan.chatIsActive ? accent : "#ccc",
//                           }}></i>
//                         {plan.chatIsActive
//                           ? "Chat System Enabled"
//                           : "Chat Not Available"}
...
//                     {isCurrent && (
//                       <div className="badge bg-warning text-dark mb-2 align-self-start">
//                         Current Plan
//                       </div>
//                     )}
//                     <h3 className="fw-bold text-navy mb-1">{plan.name}</h3>
...
//                     <div
//                       className="mb-4 p-3 rounded-4 bg-light border-start border-4"
...
//                         <span
//                           className={`small fw-bold ${plan.chatIsActive ? "text-navy" : "text-muted"}`}>
//                           {plan.chatIsActive
...
//                       onClick={() => handleSelect(plan)}
//                       disabled={isCurrent}
//                       className="btn w-100 text-white py-3 rounded-pill fw-bold border-0 mt-auto"
//                       style={{
//                         backgroundColor: isCurrent ? "#adb5bd" : "#002147",
//                       }}>
//                       {isCurrent ? "Plan Active" : "Upgrade Plan"}
...
const Pricing = () => {
  ...
  const [plans, setPlans] = useState([]);
  const [bannerHeading, setBannerHeading] = useState(""); // ⭐ Added for Dynamic Banner
  const [activeSub, setActiveSub] = useState(null);
  const [loading, setLoading] = useState(true);
...
const fetchData = async () => {
  ...
  try {
    ...
    // Set dynamic banner if available
  ...
  return (
    <div className="bg-light min-vh-100 pb-5 text-start">
      {/* ⭐ Updated Dynamic Banner Section */}
      <div
              ...
              <div key={idx} className="col-12 col-md-6 col-lg-4">
                <div className="card h-100 border-0 shadow rounded-5 overflow-hidden transition-hover">
                  ...
                  <div className="card-body p-4 p-xl-5 d-flex flex-column">
                    ...
                    {/* NEW PARAMETERS SECTION (Listings & Chat) */}
                    <div
