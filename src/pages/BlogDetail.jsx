      ...
      <div className="container px-4">
        ...
        <div className="row justify-content-center text-center mb-5">
          <div className="col-12 col-lg-8">
            ...
            <h1 className="text-navy fw-800 display-5 mb-3">{post.title}</h1>
            <div className="text-muted small fw-bold text-uppercase ls-1">
              {post.category} <span className="text-tan mx-2">•</span>{" "}
              {post.date}
            </div>
          </div>
        </div>
        ...
        <div className="row justify-content-center">
          <div className="col-12 col-lg-7">
            <article className="text-secondary fs-5 lh-lg mb-5">
              <p className="fw-bold text-navy mb-4">
                The journey to owning your first home in 2025 requires
                preparation, patience, and a clear understanding of the evolving
                real estate market.
              </p>
              <p className="mb-4">
              ...
              <h4 className="text-navy fw-800 my-4">
                Understanding Your Budget
              </h4>
              <p className="mb-4">
                Quisque non tellus orci ac auctor augue mauris augue neque. Cras
                sed felis eget velit aliquet sagittis id consectetur purus.
              </p>
              <div
                className="border-gold w-25 my-5 rounded"
                style={{ borderTop: "3px solid var(--tan)" }}></div>
            </article>
