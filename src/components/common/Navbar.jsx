...
// //   // --- Redux Store से डेटा लें ---
// //   // जैसे ही authSlice में loginUser.fulfilled होगा, ये डेटा अपने आप अपडेट हो जाएगा
// //   const { token, user: userData } = useSelector((state) => state.auth);

// //   const [logoUrl, setLogoUrl] = useState("");
// //   const [imageError, setImageError] = useState(false);

// //   // userData से जानकारी निकालें (Redux से आ रही है)
// //   const role = userData?.role;
// //   const fullName = userData?.fullName || "Guest";
// //   const profileImgPath = userData?.profileImage;
// //   const firstLetter = fullName.charAt(0).toUpperCase();
...
// //   useEffect(() => {
// //     // लोगो फेच करने का लॉजिक (इसे ऐसे ही रहने दें)
// //     const fetchLogo = async () => {
// //       try {
// //         const res = await getLogoAPI();
// //         if (res && res.logo && res.logo.logo) {
...
// //     };
// //     fetchLogo();
// //   }, []); // अब यहाँ syncProfile की ज़रूरत नहीं है
...
// //   const handleLogout = () => {
// //     dispatch(logout()); // Redux logout को कॉल करें (ये localStorage भी साफ़ कर देगा)
// //     navigate("/");
// //     // यहाँ रिफ्रेश की ज़रूरत पड़ सकती है क्योंकि state पूरी तरह साफ़ हो रही है,
// //     // लेकिन लॉगिन/साइनअप के समय नहीं पड़ेगी।
// //   };
