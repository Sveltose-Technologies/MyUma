...
import { Link, useNavigate } from "react-router-dom";
import { clearStorage } from "../../utils/storage";
import { getLogoAPI, getImgURL } from "../../services/authService"; // Ensure these are imported
  ...
  useEffect(() => {
    const fetchLogo = async () => {
      try {
        ...
        // Check if res.logo exists and then access the inner logo property
        if (res && res.logo && res.logo.logo) {
          // res.logo.logo is "/uploads/logo-177..."
